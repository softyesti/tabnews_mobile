...
final class ThemeLightColors extends ThemeColors {
  const ThemeLightColors({
    ...
    super.secondary = const Color.fromRGBO(255, 255, 255, 0.8),
...
final class ThemeDarkColors extends ThemeColors {
  const ThemeDarkColors({
    ...
    super.secondary = const Color.fromRGBO(13, 17, 23, 0.8),
...
final class ThemeBlackColors extends ThemeColors {
  const ThemeBlackColors({
    super.primary = const Color(0xFF2F81F7),
    super.onPrimary = const Color(0xFFE6EDF3),
    super.secondary = const Color(0xFF000000),
    super.onSecondary = const Color(0xFFF2F2F2),
    super.tertiary = const Color(0xFF101010),
    super.onTertiary = const Color(0xFFF2F2F2),
    super.success = const Color(0xFF000000),
    super.onSuccess = const Color(0xFF000000),
    super.warning = const Color(0xFF000000),
    super.onWarning = const Color(0xFF000000),
    super.danger = const Color(0xFF000000),
    super.onDanger = const Color(0xFF000000),
    super.surface = const Color(0xFF0C0C0C),
    super.onSurface = const Color(0xFFF2F2F2),
    super.border = const Color(0xFF161616),
    super.text = const Color(0xFFF2F2F2),
    super.textAlt = const Color(0xFF808080),
    super.background = const Color(0xFF000000),
  });
}

final class ThemeClassicalLightColors extends ThemeColors {
  const ThemeClassicalLightColors({
    super.primary = const Color(0xFF0969da),
    super.onPrimary = const Color(0xFFFFFFFF),
...
final class ThemeClassicalDarkColors extends ThemeColors {
  const ThemeClassicalDarkColors({
    super.primary = const Color(0xFF2F81F7),
    super.onPrimary = const Color(0xFFE6EDF3),
